 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
        ...
        <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Manage Class Teachers</h6>
             <a class="collapse-item" href="createClassTeacher.php">Créer un Professeur</a>
             <a class="collapse-item" href="manageUsers.php?type=teachers">Gérer les Professeurs</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="manageUsers.php?type=students">Gérer les Étudiants</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="systemSettings.php">
          ...
          <span>Paramètres Système</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="viewLogs.php">
          <i class="fas fa-history"></i>
          <span>Logs et Audit</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="importExport.php">
          <i class="fas fa-file-import"></i>
          <span>Import/Export</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="globalStatistics.php">
          <i class="fas fa-chart-pie"></i>
          <span>Statistiques Globales</span></a>
      </li>
      <hr class="sidebar-divider">
