...
CREATE TABLE `tblattendance` (
  ...
  `statusType` varchar(20) DEFAULT 'absent' COMMENT 'present, absent, late, justified',
  `dateTimeTaken` varchar(20) NOT NULL,
  `comment` text DEFAULT NULL,
  `participation` tinyint(1) DEFAULT NULL COMMENT '0=Non, 1=Oui, NULL=Non activé',
  `participationScore` decimal(3,2) DEFAULT NULL COMMENT 'Barème 0-2 si activé',
  `participationComment` text DEFAULT NULL,
  `isJustified` tinyint(1) DEFAULT 0,
  `justificationId` int(10) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
CREATE TABLE `tblsessions` (
  ...
  `duration` int(10) DEFAULT NULL COMMENT 'Durée en minutes',
  `mode` varchar(20) DEFAULT 'presentiel' COMMENT 'presentiel, distanciel',
  `isOpen` tinyint(1) DEFAULT 0 COMMENT '0=Fermé, 1=Ouvert',
...
--
-- Table structure for table `tbljustifications`
--

CREATE TABLE `tbljustifications` (
  `Id` int(10) NOT NULL,
  `admissionNo` varchar(255) NOT NULL,
  `sessionId` int(10) DEFAULT NULL,
  `attendanceId` int(10) DEFAULT NULL,
  `classId` varchar(10) NOT NULL,
  `classArmId` varchar(10) NOT NULL,
  `justificationDate` date NOT NULL,
  `filePath` varchar(500) DEFAULT NULL,
  `fileName` varchar(255) DEFAULT NULL,
  `fileType` varchar(10) DEFAULT NULL COMMENT 'pdf, jpg, png',
  `motif` text NOT NULL,
  `comment` text DEFAULT NULL,
  `status` varchar(20) DEFAULT 'pending' COMMENT 'pending, accepted, refused',
  `reviewedBy` int(10) DEFAULT NULL COMMENT 'ID du professeur ou admin',
...
CREATE TABLE `tblnotifications` (
  ...
  `userType` varchar(20) NOT NULL COMMENT 'student, teacher, admin',
  `type` varchar(50) NOT NULL COMMENT 'absence, justification, alert, etc.',
...
--
-- Table structure for table `tblteachercourses`
--
...
--
-- Indexes for table `tbljustifications`
--
ALTER TABLE `tbljustifications`
  ADD PRIMARY KEY (`Id`);
...
--
-- Indexes for table `tblteachercourses`
--
ALTER TABLE `tblteachercourses`
  ADD PRIMARY KEY (`Id`);
...
--
-- AUTO_INCREMENT for table `tbljustifications`
--
ALTER TABLE `tbljustifications`
  MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tblstudentcourses`
--
ALTER TABLE `tblstudentcourses`
  MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tblteachercourses`
--
ALTER TABLE `tblteachercourses`
  MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT;
...
INSERT INTO `tblsystemsettings` (`Id`, `settingKey`, `settingValue`, `description`, `dateModified`) VALUES
(1, 'absence_threshold', '5', 'Seuil d''absences avant alerte', NOW()),
(2, 'auto_enrollment', '0', 'Auto-enregistrement activé (0=Non, 1=Oui)', NOW()),
(3, 'participation_enabled', '1', 'Participation activée (0=Non, 1=Oui)', NOW()),
(4, 'participation_scale', 'binary', 'Type de barème participation (binary=Oui/Non, scale=0-2)', NOW());
